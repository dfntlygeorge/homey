...
interface ReviewSystemMessageProps {
  addressId: number;
  listingTitle: string;
  onDismiss: () => void;
  existingReview?: {
...
export function ReviewSystemMessage({
  addressId,
  listingTitle,
  onDismiss,
  existingReview,
}: ReviewSystemMessageProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        setComment("");
        setHoveredRating(0);
        onDismiss(); // Hide the system message after successful submission
      } else {
  ...
  if (existingReview) {
    // Show feedback message if user already reviewed
    return (
      <div className="mx-4 mb-4 bg-green-50 border border-green-200 rounded-lg p-4 shadow-sm">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-green-700">
                Thank you for reviewing {listingTitle}! Your feedback helps
                other students.
              </p>
            </div>
          </div>
  ...
  return (
    <div className="mx-4 mb-4 bg-blue-50 border border-blue-200 rounded-lg shadow-sm">
      <div className="p-4">
        <div className="flex items-start justify-between">
          <div className="flex items-start space-x-3">
            <div className="flex-shrink-0">
              ...
              {!isCollapsed && (
                <div className="space-y-3">
                  <p className="text-sm text-blue-700">
                    How was your stay at <strong>{listingTitle}</strong>? Your
