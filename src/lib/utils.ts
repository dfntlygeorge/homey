...
// Helper function to normalize address strings for comparison
export const normalizeAddress = (address: string): string => {
  return address
    ...
    .replace(
      /\b(st|street|ave|avenue|rd|road|blvd|boulevard|dr|drive|ln|lane|way|place|pl|ct|court)\b/g,
      ""
    ) // Remove common street suffixes
    .replace(/\b(apt|apartment|unit|suite|ste|#)\s*\w+/g, "") // Remove apartment/unit numbers
    .trim();
};
